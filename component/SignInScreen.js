...
export default function SignInScreen({navigation, route}){
    ...
    return(
        ...
        <View>
<TouchableOpacity style={{backgroundColor:"#282424", width:'80%', borderRadius:20,padding:10, alignSelf:'center', marginTop:10}}
...
<Text style={{color:'white', textAlign:'center', fontSize:20,fontWeight:'bold'}}>LOGIN</Text>
    ...
    <View style={{flexDirection:'row', alignItems:'center', margin:15}}>
        ...
        <Text style={{flex:1, textAlign:'center',fontWeight:'bold', fontSize:15, color:'grey'}}>Sign In with</Text>
        <View style={{borderBottomWidth:1, width:'35%', borderBottomColor:'grey'}}></View>
    </View>
    <View style={{flexDirection:'row', justifyContent:'space-around', marginTop:20}}>
        ...
        <TouchableOpacity>
            <Image source={require('../assets/logos_linkedin-icon.png')} style={{width:60, height:60}}></Image>
        </TouchableOpacity>
        <TouchableOpacity>
            <Image source={require('../assets/grommet-icons_google.png')} style={{width:60, height:60}}></Image>
        </TouchableOpacity>
    </View>
