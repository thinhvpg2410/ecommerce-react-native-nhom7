        ...
        <CommonLayout title={'Fresh Fruit'}>
          <View style={{flex:1}}>
           ...
           loop={true}
            ...
            <View style={{flex:1}}>
            {noResults ? (
    <Text style={{textAlign: 'center', marginTop: 20}}>Không có dữ liệu bạn tìm kiếm.</Text>
) : (
    <FlatList
        data={displayProduct}
        ...
        renderItem={({item}) => (
            <TouchableOpacity
                style={{borderColor: '#BCC1CA', borderWidth: 1, width: '48%', marginVertical: 5, marginRight: 6, borderRadius: 15}}
